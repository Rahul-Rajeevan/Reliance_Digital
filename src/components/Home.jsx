...
const Home = () => {
  ...
  return (
    <div>
      <img
        style={{ width: "100%" }}
        src="https://www.reliancedigital.in/medias/Boot-Up-ICICI-Offer-Carousel-Banner-14-07-2022.jpg?context=bWFzdGVyfGltYWdlc3wyNTQ0MDh8aW1hZ2UvanBlZ3xpbWFnZXMvaDgxL2hmNS85ODYxNDY0NjIxMDg2LmpwZ3xmYzQzYzE3MTg1YTk5MjE5OWU4ZTE3ODYzNjU1ZmIxYzg1Mjc0YThjZmMyYWYxNGE2NjRmZjM2OTNkMTI5NDMx"
        alt="no"
      />
      ...
      <br />
      <h1 className={Style.zz}>OFFER YOU CANNOT MISS</h1>
      <br />
      <div
        style={{
          display: "grid",
      ...
      <br />
      <div style={{ display: "flex", alignItems: "baseline" }}>
        <h1 className={Style.zz}>TOP SELLERS FROM TCL & IFFALCON |</h1>
        <br />
      ...
      <div style={{ display: "flex", justifyContent: "space-around" }}>
        ...
        <div>
          <img
            style={{ height: "350px" }}
            src="https://www.reliancedigital.in/medias/Top-seller-from-TCL-IFFALCON.jpg?context=bWFzdGVyfGltYWdlc3wxNTY1NTl8aW1hZ2UvanBlZ3xpbWFnZXMvaGMyL2hmNS85ODU5NzA0Njg0NTc0LmpwZ3w5ZTg5YzdmNDlkZTAzY2YyZjY1NzY4NzA3MGFjMzJlZTkyNTIyZGJmY2U0NjMxN2E3NWVkODM3NTI0ZDIzYWI1"
            alt="no"
          />
        </div>
      </div>
